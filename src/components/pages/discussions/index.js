...
export const Discussions = () => {
    ...
    const getDiscussionPosts = () => {
        if (isAuth()) {
            ...
            axiosInstance.get(process.env.REACT_APP_BASE_URL + "discussion-posts", {
                headers: {
            ...
            console.log('on discussion posts: no cookies');
        }
    }

    const confirmReport = discussionId => {
